...
def run_episode(
    ...
    result = {
        ...
        # Robustness companions: geometric-mean ARI and Sen-welfare
        # equity. Grounding lives in the resilience.py module
        # docstring; these populate the robustness-table cells when
        # generated by aggregate_seeds.
