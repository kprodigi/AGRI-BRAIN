...
def test_typographic_hierarchy_reserves_bold_for_titles():
    ...
    assert axes.yaxis.label.get_fontweight() == "normal"
    assert all(label.get_fontweight() == "normal" for label in axes.get_xticklabels())
