...
def _validate_temporal_stability() -> None:
    """Within-trace temporal stability outputs (renamed 2026-06 from
    external_validity_* to reflect the actual construct)."""
    for name in (
...
def _validate_threshold_assertions() -> None:
    """Per-claim threshold assertions for the headline published metrics.
    ...
    Thresholds are intentionally generous (plausibility bounds, not the
