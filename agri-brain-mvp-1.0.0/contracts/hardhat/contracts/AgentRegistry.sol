...
///         participation in the multi-agent decision system.
contract AgentRegistry {
    ...
    function register(bytes32 id, string calldata role, string calldata meta) external {
        agents[msg.sender] = Agent({id: id, role: role, meta: meta, active: true});
        emit Registered(msg.sender, id, role, meta);
    }
