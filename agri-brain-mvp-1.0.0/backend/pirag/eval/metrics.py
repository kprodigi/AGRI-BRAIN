"""
Evaluation metrics for retrieval-augmented evidence quality.

Includes faithfulness, attribution precision/recall, evidence coverage,
and expected calibration error for confidence scoring.
"""
