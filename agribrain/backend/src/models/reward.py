...
Design rationale
----------------
The reward is intentionally simple — a linear combination of the two
primary objectives — because:
...
3. Sufficient: with SLCA already encoding carbon, labour, resilience,
   and transparency as a composite, the reward captures all five
...
----------
    ...
    - Vamplew, P. et al. (2011). Empirical evaluation methods for
      multiobjective reinforcement learning algorithms. Machine
      Learning, 84(1), 51–80.
"""
